...
import { Container, LogoIcon } from "../atoms";
          ...
          <ul className="mr-auto ml-auto flex flex-col items-center gap-5 md:flex-row md:gap-8">
            {routes.map((route) => (
              <li
                ...
                className="text-200 tracking-600 leading-300 font-bold text-white uppercase transition-all delay-0 duration-300 ease-in hover:text-brand-500 focus:text-brand-500"
