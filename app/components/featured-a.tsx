...
const FirstFeaturedProduct = () => {
  return (
    <article
      className={`grid grid-cols-1 gap-7 overflow-y-hidden rounded-lg bg-brand-500 bg-[url('/assets/home/desktop/pattern-circles.svg')] bg-cover bg-[center_-9rem] bg-no-repeat px-7 py-12 md:grid-cols-2 md:gap-24 md:bg-[-16rem_-3rem] md:px-24 md:pt-24 md:pb-0 lg:gap-16 lg:pl-12`}
    >
