              ...
              <li className='flex flex-col gap-4'>
                <div className='flex flex-col'>
                  ...
                  <input
                    ...
                    name='text-1'
                    id='text-1'
                    className='flex-1 py-5 border border-primary-200 focus-visible:border-primary-200 rounded-md bg-primary-100'
                ...
                <label className='block'>
                  ...
                  <input
                    type='text'
                    id='tbone'
                    className='mt-1 block w-full px-3 py-2 bg-white border border-primary-300 rounded-md text-300 shadow-sm placeholder-primary-300 focus:outline-none focus:border-primary-200 focus:ring-1 focus:ring-primary-200 invalid:border-accent-200 invalid:text-accent-200 focus:invalid:border-accent-200 focus:invalid:ring-accent-200'
                    placeholder='tbone'
                  />
                </label>
              </li>
