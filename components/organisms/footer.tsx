...
export function Footer() {
  return (
    <footer className='bg-neutral-950'>
      <Container>
        <section className="relative py-20 text-white/75 before:absolute before:top-0 before:left-2/4 before:h-1 before:w-24 before:-translate-x-2/4 before:bg-brand-500 before:content-[''] before:md:left-0 before:md:translate-x-0">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <route.Icon aria-hidden='true' className='icon' />
                    </a>
                  </li>
                );
              })}
