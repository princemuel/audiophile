/*
  ...
  - Added the required column `desktop` to the `related_products` table without a default value. This is not possible if the table is not empty.
  - Added the required column `mobile` to the `related_products` table without a default value. This is not possible if the table is not empty.
  - Added the required column `tablet` to the `related_products` table without a default value. This is not possible if the table is not empty.
